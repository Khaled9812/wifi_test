...
// *
// * FreeRTOS-enabled camera-to-display demo using tasks.
// */
//
...
//static void camera_display_task(void *pvParameters);
//
///*******************************************************************************
// * Variables
// ******************************************************************************/
...
//    BOARD_InitHardware();
//
//    PRINTF("CSI MIPI YUV FreeRTOS demo start...\r\n");
//
...
//    DEMO_InitPxp();
//
//    /* Create display/camera task */
//    xTaskCreate(camera_display_task, "CamDispTask", configMINIMAL_STACK_SIZE + 512, NULL, tskIDLE_PRIORITY + 2, NULL);
//
//    vTaskStartScheduler();
//
...
//}
//
///* This replaces DEMO_CSI_MIPI_YUV */
//static void camera_display_task(void *pvParameters)
//{
//    (void)pvParameters;
...
//    for (;;)
//    {
//        /* Wait to get a full frame buffer to show. */
